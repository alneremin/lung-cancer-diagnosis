...
class Ui_authorization(object):
    def setupUi(self, authorization):
        ...
        self.userNam = QtWidgets.QLineEdit(authorization)
        self.userNam.setGeometry(QtCore.QRect(120, 130, 161, 22))
        self.userNam.setStyleSheet("background-color: white")
        self.userNam.setEchoMode(QtWidgets.QLineEdit.Normal)
...
"color: black")
        ...
        self.label_2.setPixmap(QtGui.QPixmap("img/key.png"))
